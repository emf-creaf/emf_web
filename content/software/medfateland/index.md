...
## Documentation and training
  ...
  - A number of *vignettes* illustrate how to initialize inputs and run
    ...
    [here](https://emf-creaf.github.io/medfateland/articles/). The user
    is also advised to read the articles about package **medfate**
    included [here](https://emf-creaf.github.io/medfate/articles/).
  ...
  - Presentation slides for a course devoted to process-based forest
    modelling using packages **medfate** and **medfateland** can be
    found [here](https://emf.creaf.cat/training/medfate_course/).
